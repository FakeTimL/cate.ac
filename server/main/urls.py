...
urlpatterns = [
  ...
  path('my_submission/<int:pk>/', views.UserSubmissionView.as_view(), name='user_submission'),  # type: ignore
  ...
  path('my_attempt/<int:pk>/', views.UserAttemptView.as_view(), name='user_attempt'),  # type: ignore
]
